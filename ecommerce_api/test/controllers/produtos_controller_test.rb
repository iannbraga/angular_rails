...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { descricao: @produto.descricao, quantidade: @produto.quantidade, titulo: @produto.titulo, valor: @produto.valor } }, as: :json
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, quantidade: @produto.quantidade, titulo: @produto.titulo, valor: @produto.valor } }, as: :json
    assert_response :success
  end
